          ...
          >
            <View style={styles.cardHeader}>
              ...
              <View style={[
                ...
                item.difficulty === 'BEGINNER' && styles.difficultyEasy,
                item.difficulty === 'INTERMEDIATE' && styles.difficultyMedium,
                (item.difficulty === 'ADVANCED' || item.difficulty === 'EXPERT') && styles.difficultyHard,
              ]}>
